                                ...
                                <div class="col-md-12">
                                    ...
                                    <div class="panel">
                                        ...
                                        <div class="panel-body">
                                            ...
                                            <div class="form-group">
                                                <label for="disabledInput" class="col-lg-2 control-label"  style="vertical-align: top;text-align: justify;">Total Dibayarkan</label>
                                                <div class="col-lg-10">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-lg-5">
                                                    <p class="form-control-static text-muted" style="vertical-align: top;"><input type="text" name="angsuran1" class="form-control" placeholder="Pembayaran Awal Disepakati"></p>
                                                </div>
                                                <div class="col-lg-5">
                                                    <p class="form-control-static text-muted" style="vertical-align: top;"> <input type="text" id="datepicker1" name="tg_angsuran1" class="form-control" placeholder="Masukkan Tanggal Awal Disepakati" value="<?php echo"$tg_ou1";?>"></p>
                                                </div>
                                            </div>
                                            <div class="form-group">
                                    ...
                                    <div class="panel">
                                        ...
                                        <div class="panel-body">
                                            ...
                                            <div class="form-group">
                                                <label for="disabledInput" class="col-lg-2 control-label"  style="vertical-align: top;text-align: justify;">Pembayaran Diawal</label>
                                                <div class="col-lg-5">
                                                    <p class="form-control-static text-muted" style="vertical-align: top;"><input type="text" name="angsuran1" class="form-control" placeholder="Pembayaran Awal Disepakati" value="<?php echo"$t_byr[3]";?>"></p>
                                                </div>
                                                <div class="col-lg-5">
                                                    <p class="form-control-static text-muted" style="vertical-align: top;"> <input type="text" id="datepicker1" name="tg_angsuran1" class="form-control" placeholder="Tanggal Pembayaran Awal Disepakati"  value="<?php echo"$t_byr[4]";?>"></p>
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                <label for="disabledInput" class="col-lg-2 control-label"  style="vertical-align: top;text-align: justify;">Angsuran 1</label>
