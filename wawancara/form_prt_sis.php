                                        ...
                                        <p class="fs15 mb20">
                                            ...
                                            else
                                            {
                                                ...
                                                <form method="post" action="#" enctype="multipart/form_data">
                                                    ...
                                                    <?php
                                                        $ar_st=array("Terdaftar","Batal Mendaftar");
                                                        $ar_dt=array("Terdaftar","Cadangan");
                                                        for($i=0;$i<=1;$i++)
                                                        {
                                                            ?>
                                                            <option value="<?php echo"$ar_st[$i]";?>">
                                        ...
                                        <div class="panel">
                                            ...
                                            <div class="panel-body">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-lg-10">
                                                        <p class="form-control-static text-muted" style="vertical-align: top;"><?php echo"$tp_dt_sis[37]";?></p>
                                                    </div>
                                                </div>
                                                <div class="form-group">
