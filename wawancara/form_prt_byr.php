                                    ...
                                    <div class="panel">
                                        ...
                                        <div class="panel-body">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-lg-5">
                                                    <p class="form-control-static text-muted" style="vertical-align: top;"> <input type="text" id="datepicker2" name="tg_angsuran2" class="form-control" placeholder="Tanggal Angsuran Pertama" value="<?php echo"$tg_ou1";?>"></p>
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                <label for="disabledInput" class="col-lg-2 control-label"  style="vertical-align: top;text-align: justify;">Angsuran 2</label>
                                                <div class="col-lg-5">
                                                    <p class="form-control-static text-muted" style="vertical-align: top;"><input type="text" name="angsuran3" class="form-control" placeholder="Tanggal Angsuran 2"></p>
                                                </div>
                                                <div class="col-lg-5">
