                                    ...
                                    <div class="panel">
                                        ...
                                        <div class="panel-body">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-lg-5">
                                                    <p class="form-control-static text-muted" style="vertical-align: top;"><input type="text" name="angsuran2" class="form-control" placeholder="Nominal Angsuran 1"></p>
                                                </div>
                                                <div class="col-lg-5">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-lg-5">
                                                    <p class="form-control-static text-muted" style="vertical-align: top;"><input type="text" name="angsuran3" class="form-control" placeholder="Nominal Angsuran 2"></p>
                                                </div>
                                                <div class="col-lg-5">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-lg-5">
                                                    <p class="form-control-static text-muted" style="vertical-align: top;"><input type="text" name="angsuran4" class="form-control" placeholder="Nominal Angsuran 3"></p>
                                                </div>
                                                <div class="col-lg-5">
                                    ...
                                    <div class="panel">
                                        ...
                                        <div class="panel-body">
                                            ...
                                            <div class="form-group">
                                                <label for="disabledInput" class="col-lg-2 control-label"  style="vertical-align: top;text-align: justify;">Angsuran 1</label>
                                                <div class="col-lg-5">
                                                    <p class="form-control-static text-muted" style="vertical-align: top;"><input type="text" name="angsuran2" class="form-control" placeholder="Nominal Angsuran 1" value="<?php echo"$t_byr[5]";?>"></p>
                                                </div>
                                                <div class="col-lg-5">
                                            ...
                                            <div class="form-group">
                                                <label for="disabledInput" class="col-lg-2 control-label"  style="vertical-align: top;text-align: justify;">Angsuran 2</label>
                                                <div class="col-lg-5">
                                                    <p class="form-control-static text-muted" style="vertical-align: top;"><input type="text" name="angsuran3" class="form-control" placeholder="Nominal Angsuran 2" value="<?php echo"$t_byr[7]";?>"></p>
                                                </div>
                                                <div class="col-lg-5">
                                            ...
                                            <div class="form-group">
                                                <label for="disabledInput" class="col-lg-2 control-label"  style="vertical-align: top;text-align: justify;">Angsuran 3</label>
                                                <div class="col-lg-5">
                                                    <p class="form-control-static text-muted" style="vertical-align: top;"><input type="text" name="angsuran4" class="form-control" placeholder="Nominal Angsuran 3" value="<?php echo"$t_byr[9]";?>"></p>
                                                </div>
                                                <div class="col-lg-5">
